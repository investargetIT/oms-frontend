...
const Connect = (props: any, Ref: any) => {
  ...
  const r3Cols: any[] = [
    ...
    { title: '员工工号', width: 150, dataIndex: 'contactCode', ellipsis: true, search: false },
    { title: '员工名称', width: 150, dataIndex: 'contactName', ellipsis: true, search: true },
    {
      title: '状态',
      width: 150,
      dataIndex: 'effective',
    ...
    { title: '部门', width: 260, dataIndex: 'email', ellipsis: true, search: false },
    { title: '职位', width: 150, dataIndex: 'mobile', ellipsis: true, search: false },
  ];
  ...
  function open(customerCode_: any) {
    setCustomerCode(customerCode_ || '0600176014');
